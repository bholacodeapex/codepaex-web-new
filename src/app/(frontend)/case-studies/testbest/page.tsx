...
export default async function Page({ params: { slug = "home" } }) {
  ...
  return (
    <div className="h-full flex flex-col py-20">
      <div className="text-white w-full h-[40rem] md:h-[48rem] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-sky-400 to-blue-800">
        <div className="container flex flex-col gap-24 items-center">
          <div className="flex flex-col justify-start mt-12 sm:mt-20 gap-12 h-full">
            <Breadcrumbs items={breadcrumbItems} />
            <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl leading-tight font-medium">
      ...
      <div className="h-full container flex flex-col gap-8">
        ...
        <div className="flex flex-col lg:flex-row mt-20 gap-10 lg:gap-4">
          <div className="flex-1 flex flex-col gap-5 lg:gap-12">
            ...
            <div className="flex gap-2 flex-wrap">
              <div className="py-2 px-4 rounded-3xl bg-[#f3f4f6] font-medium">
                Full-stack Development
              </div>
              <div className="py-2 px-4 rounded-3xl bg-[#f3f4f6] font-medium">
                Search Engine Optimization
        ...
        <div className="flex flex-col w-full mt-20">
          <div className="grid md:grid-cols-2 w-full gap-10 md:gap-2">
            <div className="flex flex-col gap-5 md:gap-12 h-full">
              ...
              <div className="border border-1 rounded-2xl p-8 bg-sky-200 text-black">
            ...
            <div className="flex flex-col gap-5 md:gap-12">
              ...
              <div className="border border-1 rounded-2xl bg-sky-500 text-black p-8 h-full">
                <p className="text-xl sm:text-2xl md:text-3xl leading-snug">
        ...
        <div className="flex flex-col xl:flex-row mt-20 gap-10 xl:gap-48">
          <div className="flex-2 flex flex-col gap-12">
            <h2 className="text-4xl md:text-5xl font-semibold">Key Features</h2>
          </div>
          <div className="flex-1 grid sm:grid-cols-2 gap-2">
            {keyFeatures.map((ele) => (
              <div className="flex-1 border border-1 border-[#3B3486] rounded-3xl px-8 py-16">
                ...
                <p className="font-medium mt-4">{ele.desc}</p>
              </div>
            ))}
          </div>
        </div>
